...
class DailyPulseTranslator {
  static String translateTitle(BuildContext context, String title) {
    ...
    switch (title) {
      ...
      case "Action Lifestyle": return "Lifestyle Action";
  ...
  static String translateDesc(BuildContext context, String desc) {
    ...
    switch (desc) {
      ...
      case "Zéro réseaux sociaux (matin)": return "Zero social media (morning)";
      ...
      case "Prendre le soleil (15 min)": return "Get some sun (15 min)";
