...
class ValerionAudios {
  static List<LibraryAudioEntity> getCatalogue(BuildContext context) {
    return [
      LibraryAudioEntity(
        id: 'static_1',
        title: AppLocalizations.of(context)!.audioTransformerTitle,
        subtitle: AppLocalizations.of(context)!.audioTransformerSub,
      ...
      LibraryAudioEntity(
        id: 'static_2',
        title: AppLocalizations.of(context)!.audioProcrastinesTitle,
        subtitle: AppLocalizations.of(context)!.audioProcrastinesSub,
      ...
      LibraryAudioEntity(
        id: 'static_saitama',
        title: AppLocalizations.of(context)!.audioSaitamaTitle,
        subtitle: AppLocalizations.of(context)!.audioSaitamaSub,
      ...
      LibraryAudioEntity(
        id: 'static_reveiller',
        title: AppLocalizations.of(context)!.audioReveillerTitle,
        subtitle: AppLocalizations.of(context)!.audioReveillerSub,
      ...
      LibraryAudioEntity(
        id: 'static_3',
        title: AppLocalizations.of(context)!.audioObstacleTitle,
        subtitle: AppLocalizations.of(context)!.audioObstacleSub,
        audioUrl:
      ...
      LibraryAudioEntity(
        id: 'static_4',
        title: AppLocalizations.of(context)!.audioMaitriserTitle,
        subtitle: AppLocalizations.of(context)!.audioMaitriserSub,
        audioUrl:
